...
describe('Service Tests', () => {
  describe('League Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new League('9fec3727-3421-4967-b213-ba36557ca194', 0, 'AAAAAAA', false, currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not update a League', async () => {
      ...
      it('should partial update a League', async () => {
      ...
      it('should not partial update a League', async () => {
      ...
      it('should not return a list of League', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a League', async () => {
