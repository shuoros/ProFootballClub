...
import { NewsPaper } from '@/shared/model/news-paper.model';
...
describe('Service Tests', () => {
  describe('NewsPaper Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new NewsPaper('9fec3727-3421-4967-b213-ba36557ca194', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a NewsPaper', async () => {
      ...
      it('should not update a NewsPaper', async () => {
      ...
      it('should partial update a NewsPaper', async () => {
      ...
      it('should not partial update a NewsPaper', async () => {
      ...
      it('should not return a list of NewsPaper', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a NewsPaper', async () => {
