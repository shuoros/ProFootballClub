...
import club.profb.service.AdminService;
...
/**
 * REST controller for managing {@link club.profb.domain.Admin}.
 */
@RestController
@RequestMapping("/api")
public class AdminResource {
    ...
    public ResponseEntity<Admin> updateAdmin(@PathVariable(value = "id", required = false) final UUID id, @Valid @RequestBody Admin admin)
