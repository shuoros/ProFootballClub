...
describe('Service Tests', () => {
  describe('Coach Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Coach('9fec3727-3421-4967-b213-ba36557ca194', 'AAAAAAA', false, false, false, Plan.SIMPLE);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Coach', async () => {
      ...
      it('should not update a Coach', async () => {
      ...
      it('should partial update a Coach', async () => {
      ...
      it('should not partial update a Coach', async () => {
      ...
      it('should not return a list of Coach', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Coach', async () => {
