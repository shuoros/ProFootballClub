...
describe('Service Tests', () => {
  describe('FriendRequest Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new FriendRequest('9fec3727-3421-4967-b213-ba36557ca194');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a FriendRequest', async () => {
      ...
      it('should not update a FriendRequest', async () => {
      ...
      it('should partial update a FriendRequest', async () => {
        const patchObject = Object.assign({}, new FriendRequest());
      ...
      it('should not partial update a FriendRequest', async () => {
      ...
      it('should not return a list of FriendRequest', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a FriendRequest', async () => {
