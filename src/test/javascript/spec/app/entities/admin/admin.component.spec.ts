...
describe('Component Tests', () => {
  describe('Admin Management Component', () => {
    ...
    it('Should call load all on init', async () => {
      // GIVEN
      adminServiceStub.retrieve.resolves({ headers: {}, data: [{ id: '9fec3727-3421-4967-b213-ba36557ca194' }] });
      ...
      expect(comp.admins[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
